...
Скачиваем ZIP-файл проекта с GitHub       
...
![Вывод в консоль](./png/ot.png) 

Далее ввели `y` - записали поля головоломки в файл "Puzzle_fields.txt":

![Вывод в консоль](./png/fil.png) 